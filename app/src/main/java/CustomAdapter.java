...
public class CustomAdapter extends ArrayAdapter<Person> {
    ...
    public void onClick(View v) {
        ...
        {
            case R.id.item_info:
                Snackbar.make(v, "Release date " +person.getFeature(), Snackbar.LENGTH_LONG)
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.txtType.setText(person.getType());
        viewHolder.txtVersion.setText(person.getVersion_number());
